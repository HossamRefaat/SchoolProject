...
namespace SchoolProject.Core.Features.Authentication.Queries.Handles
{
    public class AuthenticationQueryHandler : ResponseHandler,
        IRequestHandler<AuthorizeUserQuerey, Response<string>>
        
    {
        ...
        public async Task<Response<string>> Handle(AuthorizeUserQuerey request, CancellationToken cancellationToken)
        {
